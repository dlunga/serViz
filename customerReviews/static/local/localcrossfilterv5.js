 ...
 //2013-05-03 14:53:00
  ...
  function serviceList(div) {
    ...
    div.each(function() {
     ...
     /*     
      var testEnter = service.enter().append("div")
          .attr("class", "services");

      var container = testEnter.append("li")
          				.attr("class", "report-container");
      var header = container.append("div")
          				.attr("class", "report-header");
          				 
      container.append("p")
          		.attr("class", "report-content")
          		.text(function(d) { return d.consumer_comment; });
          				    				
      header.append("a")
          	.attr("class", "report-profile")     				   
          	.text(function(d) { return d.consumer_name; });
          			
      container.append("div")
          		.attr("class", "report-time")     				   
          		.text(function(d) { return formatTime(d.comment_datetime); });
          		*/
