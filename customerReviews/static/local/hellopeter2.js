...
//formatDate(d.values[0].comment_datetime)      
...
function computeService() {	
      ...
      div.each(function() {
       ...
       var log = d3.select(this)
    	...
    	log.enter().append("div")
    				...
    				.attr("style","fill: #999999; stroke: #000000; background-color: #d1dcc0; font-weight:bold");
 ...
 function serviceList2(div) {
  ...
  // ----------supplier service comments -----------
      div.each(function() {
      var table = d3.select(this).selectAll('table')
      				.data(serviceBySuppliers, function(d) { return d.key; });
      
      var cells = rows.selectAll('td').data(function(d) { return d.values[0].supplier_name; });
