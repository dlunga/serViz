       ...
       var tr = d3.select(this)
		...
		var rects =	 tc_svg.selectAll("td")
						...
						function rollover(d,i) {
								 	...
								 	d3.select("#textreports").append("p").attr("style","background-color:#E8E8E8; font-size:4;").attr("class", "rollover").text(d.consumer_comment).style("color", "black").style("font-size","10");
								 };			    	
    });
...
function select_where_to_display(prov_name)
{
		if( prov_name == 1 )
		{ 
			document.addEventListener('DOMContentLoaded', function() {updateChartGP(1,101)}, false);		
		...
		{ 
			document.addEventListener('DOMContentLoaded', function() {updateChartGP(1,101)}, false);	//updateChartEC();			
		}
		...
		{ 
			document.addEventListener('DOMContentLoaded', function() {updateChartGP(1,103)}, false);		//updateChartEC();			
		}
